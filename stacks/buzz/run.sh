#!/usr/bin/env bash
# Vendored verbatim from block/buzz deploy/compose/run.sh
# @ 0571f5455b1b2aeea7334082f0df9d1f19b22f7d. Kept for on-box operator commands
# (add-member, logs, upgrade, backup-hint); ansible/roles/buzz calls `start`.
set -euo pipefail
